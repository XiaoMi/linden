...
public class TestLindenFacet extends TestLindenCoreBase {
  ...
  public void init() throws Exception {
    ...
    schema.addToFields(
        new LindenFieldSchema().setName("Author").setType(LindenType.FACET).setStored(true).setIndexed(true));
  ...
  public void facetTest8() throws Exception {
    ...
    Assert.assertEquals(2, result.getFacetResultsSize());
    Assert.assertEquals(
        "LindenHit(id:1, score:1.0, source:{\"PublishDate\":\"2010/10/15\",\"Language\":\"cn\",\"Author\":\"Bob\",\"id\":\"1\"})",
