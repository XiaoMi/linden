...
public abstract class LindenFilterBuilder {

  public static LindenFilter buildTermFilter(String field, String value) {
    return new LindenFilter().setTermFilter(
            new LindenTermFilter(
                    new LindenTerm(field, value)));
  }

  abstract public LindenFilter build();
}
